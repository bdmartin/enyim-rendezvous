using System;
using Enyim.Memcached.Locators;

namespace Enyim.Rendezvous
{
    public sealed class RendezvousNodeLocator : IMemcachedNodeLocator, IDisposable
    {
        IMemcachedKeyTransformer keyTransformer;
		public RendezvousNodeLocator(IMemcachedKeyTransformer keyTransformer)
		{
